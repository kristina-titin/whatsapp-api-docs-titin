...
Grup adalah tempat komunitas berada dalam Protokol — mereka adalah kumpulan kontak. Di halaman ini, kita akan mendalami berbagai titik akhir grup yang dapat Anda gunakan untuk mengelola grup secara terprogram. Kita akan melihat cara membuat kueri, membuat, memperbarui, dan menghapus grup. {{ className: 'lead' }}
...
<Properties>
  <Property name="group_id" type="string">
    nomor unik sebagai pembeda grup karna pasti akan banyak nama grup yang serupa.
  </Property>
  <Property name="name" type="string">
    Nama grup biasa.
  </Property>
  <Property name="description" type="string">
    Kolom deskripsi di bawah profil grup.
  </Property>
  <Property name="avatar_url" type="string">
    Foto yang diupload untuk profile akan dionlinekan dan akan ada linknya, agar dapat di lihat orang lain.
  </Property>
  <Property name="conversation_id" type="string">
    Pengidentifikasi unik untuk percakapan milik grup
  </Property>
  <Property name="contacts" type="array">
    Anggota grup akan berupakan kontak dengan menjadikan "contact_id" si user menjadi data array dalam data grup saat user masuk grup.
  </Property>
  <Property name="created_at" type="timestamp">
    Timestamp dari kapan grup dibuat.
  </Property>
  <Property name="archived_at" type="timestamp">
    Timestamp dari kapan grup di arsipkan.
  </Property>
</Properties>
